...
_worker_js__WEBPACK_IMPORTED_MODULE_5__.default.prototype.toContainer = function toContainer() {
  ...
  return orig.toContainer.call(this).thenList(prereqs).then(function toContainer_pagebreak() {
    ...
    var pxPageHeight = this.opt["html2canvas"] && this.opt["html2canvas"]["width"] ? this.opt["html2canvas"]["width"] * this.prop.pageSize.inner.ratio : this.prop.pageSize.inner.px.heightExact; // Check all requested modes.
    ...
    Array.prototype.forEach.call(els, function pagebreak_loop(el) {
      ...
      if (rules.before) {
        var blockHeight = Math.floor(pxPageHeight - clientRect.top % pxPageHeight);
        var pad = (0,_utils_js__WEBPACK_IMPORTED_MODULE_6__.createElement)("div", {
          style: {
            display: "block",
            height: "".concat(blockHeight + 1, "px")
          }
        });

        if (el.nodeName === "IMG" && el.parentNode.nodeName === "DIV") {
          el.parentNode.parentNode.insertBefore(pad, el.parentNode);
        } else {
...
Worker.prototype.toCanvas = function toCanvas() {
  ...
  return this.thenList(prereqs).then(function toCanvas_main() {
    ...
    return html2canvas__WEBPACK_IMPORTED_MODULE_11__(this.prop.container, options);
...
function toPdfIOS() {
  ...
  return this.thenList(prereqs).then( /*#__PURE__*/function () {
    var _toPdf_pagebreak_internal = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var opt, haveHeader, root, pxPageWidth, pxPageHeight, clientBoundingRect, pxFullHeight, nPages, page, options, canvas, imgData;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              opt = this.opt;
              haveHeader = opt.haveHeader;
            ...
            case 21:
              ...
              this.prop.pdf.addImage(imgData, opt.image.type, opt.margin[1], haveHeader && page === 0 ? 0 : opt.margin[0], this.prop.pageSize.inner.width, this.prop.pageSize.inner.height);
...
function toPdf() {
  ...
  return this.thenList(prereqs).then(function toPdf_main() {
    ...
    var opt = this.opt;
    var haveHeader = opt.haveHeader; // Calculate the number of pages.
    ...
    for (var page = 0; page < nPages; page++) {
      ...
      this.prop.pdf.addImage(imgData, opt.image.type, opt.margin[1], haveHeader && page === 0 ? 0 : opt.margin[0], this.prop.pageSize.inner.width, pageHeight);
    }
  });
}
